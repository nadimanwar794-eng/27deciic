    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 px-4 font-sans py-10">
      <div className="bg-white p-8 rounded-3xl shadow-xl w-full max-w-md border border-slate-200 relative overflow-hidden">
        ...
        <div className="text-center mb-8 relative z-10 flex flex-col items-center">
          <img src="/logo.png" alt="IIC Logo" className="w-32 h-32 object-contain mb-2" />
          <h1 className="text-2xl font-black text-slate-900 mb-1 tracking-tight">IIC ONLINE CLASSES</h1>
          <p className="text-blue-600 font-bold tracking-widest text-xs uppercase">IIC AI Learning System</p>
        </div>
