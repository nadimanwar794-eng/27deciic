       ...
       <div className="aspect-video bg-black w-full sticky top-[73px] z-10 relative">
           {activeVideo ? (
               <>
                   ...
                   />
                   {/* WATERMARK */}
                   <div className="absolute top-4 right-4 z-20 opacity-40 pointer-events-none animate-pulse">
                       <img src="/logo.png" alt="Watermark" className="w-16 h-16 object-contain drop-shadow-lg" />
                   </div>
               </>
           ) : (
