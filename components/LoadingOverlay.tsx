...
export const LoadingOverlay: React.FC<Props> = ({ dataReady, onComplete }) => {
  ...
  useEffect(() => {
    ...
    if (progress < 100) {
      ...
      const speed = 100; // 10s Total Duration
    ...
    <div className="fixed inset-0 z-50 bg-slate-900/95 backdrop-blur-md flex flex-col items-center justify-center text-white">
      <div className="w-full max-w-md px-8 text-center">
        ...
        <div className="relative mb-8 inline-block">
            ...
            <img src="/logo.png" alt="IIC AI" className="w-24 h-24 object-contain relative z-10 animate-bounce" />
        </div>

        <h2 className="text-2xl font-bold mb-2 tracking-tight">IIC AI Processing...</h2>
