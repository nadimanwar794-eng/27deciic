    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-950/95 backdrop-blur-md p-4 animate-in fade-in duration-500">
       <div className="relative w-full max-w-sm bg-slate-900 border border-slate-700 rounded-[2rem] p-8 text-center shadow-2xl overflow-hidden ring-1 ring-slate-800">
           ...
           <div className="relative z-10">
               {/* GLOWING LOGO */}
               <div className="w-24 h-24 mx-auto mb-6 bg-blue-600 rounded-2xl flex items-center justify-center shadow-[0_0_30px_rgba(37,99,235,0.6)] animate-bounce-slow overflow-hidden p-2">
                   <img src="/logo.png" alt="IIC Logo" className="w-full h-full object-contain" />
               </div>
               ...
               <div className="mt-6 flex flex-col items-center justify-center gap-2">
                   <div className="flex items-center justify-center gap-2">
                       <img src="/logo.png" alt="IIC Logo" className="w-6 h-6 object-contain" />
