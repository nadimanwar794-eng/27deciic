        ...
        >
            ...
            <div className="mb-8">
                ...
                <div className="mb-6 relative flex justify-center">
                    <img src="/logo.png" alt="IIC Logo" className="w-32 h-32 object-contain relative z-10 drop-shadow-[0_0_20px_rgba(255,255,255,0.8)]" />
            ...
            <div className="mt-12 flex items-center justify-center gap-3 text-sm font-bold opacity-60 uppercase tracking-[0.2em] animate-pulse">
